        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-12">
          ...
          <div className="space-y-6 lg:max-w-md">
            ...
            <p className="text-xl text-white font-bold leading-relaxed whitespace-pre-line">
              {`Leading the way for a smarter 
and more secure digital era.`}
            </p>
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.facebook.com/Netpoleon.ANZ"
                target="_blank"
                rel="noopener noreferrer"
                className="w-6 h-6 bg-transparent rounded-full flex items-center justify-center hover:bg-white/80 transition-colors"
              >
                <svg
          ...
          <div className="flex flex-col sm:flex-row gap-8 lg:gap-12 lg:ml-16">
            {/* Get Started */}
            <div className="space-y-6">
              <h4 className="text-xl font-semibold text-white">Get Started</h4>
