...
export default function InfoSection({ title, points, visual, image, imageAlt }: InfoSectionProps) {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            {image ? (
              ...
              <span className="text-gray-500 text-lg font-medium">Info Visual</span>
            )}
          </motion.div>
        </div>
      </div>
