...
export default function Statistics() {
  ...
  useEffect(() => {
    function animateWithRandomNumber(
      myClass: string,
      from: number,
      to: number
    ) {
