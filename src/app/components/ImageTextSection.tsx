...
export default function ImageTextSection({
  ...
  return (
    <section className="py-16 bg-gray-50 relative overflow-hidden">
      ...
      <div className={`absolute ${isLeftLayout ? 'right-0' : 'left-0'} top-1/2 transform -translate-y-1/2 w-96 h-96 bg-primary/5 rounded-full blur-3xl`}></div>
            ...
            <div className="relative h-80 lg:h-96 rounded-2xl overflow-hidden shadow-xl transform hover:scale-105 transition-transform duration-500">
              ...
              {imageSrc ? (
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                  <span className="text-gray-500 text-base font-medium">{imageAlt || 'Image Placeholder'}</span>
                </div>
              )}
            </div>
          </motion.div>
